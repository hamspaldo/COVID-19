...
checks.australia <- select(checks,country_state,"3/17/20")
```
...
get.data("time_series_19-covid-Confirmed.csv",group_label="Confirmed")
get.data("time_series_19-covid-Deaths.csv",group_label="Deaths")
get.data("time_series_19-covid-Recovered.csv",group_label="Recovered")
